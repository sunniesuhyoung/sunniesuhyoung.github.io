...
function compareElem(){
    ...
    function gameStatus(){
        console.log(counterVar, cmpCount, gameset[cmpCount], arrayCmp(gameset[cmpCount], sortArray));
    ...
    function gameWin(){
        ...
        gameSuccess = true;
        sendResult(gameSuccess, sort_algo);
    }
...
function sendResult(gameSuccess, sort_algo){
    ...
    xmlhttp.send("data1="+gameSuccess+"&data2="+sort_algo);
}
